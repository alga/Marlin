...
#define STRING_CONFIG_H_AUTHOR "Albertas Agejevas" // Who made the changes.
...
#define CUSTOM_MENDEL_NAME "Prusa i2"
...
#define DEFAULT_AXIS_STEPS_PER_UNIT   {80, 80, 2560, 789.6}  // default steps per unit for Ultimaker
